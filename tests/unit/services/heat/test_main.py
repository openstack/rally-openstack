...
from rally_openstack.services.heat import main
...
class StackTestCase(test.ScenarioTestCase):
    ...
    @mock.patch("rally_openstack.services.heat.main.open",
                create=True)
    ...
    @mock.patch("rally_openstack.services.heat.main.utils")
    ...
    @mock.patch("rally_openstack.services.heat.main.open")
    @mock.patch("rally_openstack.services.heat.main.Stack._wait")
