...
from rally_openstack.scenarios.mistral import executions
from tests.unit import test

BASE = "rally_openstack.scenarios.mistral.executions"
MISTRAL_WBS_BASE = "rally_openstack.scenarios.mistral.workbooks"
