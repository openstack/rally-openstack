...
tagged version:
    ...
    $ docker pull xrally/xrally-openstack:4.1.0
...
* use docker volumes. It is the easiest way. You just need to do something like:
      ...
      $ docker run -v rally_volume:/home/rally/.rally xrally/xrally-openstack:4.1.0 env create --name "foo"
...
* mount outer directory inside the container
      ...
      $ docker run -v /var/lib/rally_container:/home/rally/.rally xrally/xrally-openstack:4.1.0 db create

      # And finally, you can start doing your things.*
      $ docker run -v /var/lib/rally_container:/home/rally/.rally xrally/xrally-openstack:4.1.0 env create --name "foo"
